...
import { setTextAnimation } from "./textAnimation"
...
function Error404() {
    ...
    return <>
        <a href='https://sumitkawale.github.io/portfolio/'>
        ...
        <div className='errorDiv'>
            <h1>Error <span style={{ color: 'orangered', display: "inline-block" }} className="animate animateText">404</span></h1>
            <p>Page Not Found. <span className='animate animateText' style={{ color: "#f7df1e", display: "inline-block", background: "#323330", padding: "5px", borderRadius: "5px" }}>You Entered Wrong URL</span></p>
        </div>
    </>
}
